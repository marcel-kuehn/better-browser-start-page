...
export default function StopWatchWidget(props: StopWatchWidget) {
  ...
  return (
    <Widget {...props} className="flex flex-col items-center justify-center gap-2 text-center">
      <p className="text-foreground letter-spacing-wide text-6xl font-semibold">
